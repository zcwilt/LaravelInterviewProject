...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/tasks',  [App\Http\Controllers\TaskController::class, 'save']);
    ...
    Route::get('/highpriority', [App\Http\Controllers\HighPriorityController::class, 'index'])->name('highpriority');
